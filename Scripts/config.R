...
#input counts_file
counts_file <- "~/Luka_graduation/final_results/Input_data/AE_bulk_RNA_batch1.minRib.PC_07042023.txt"

#output normalized counts
normalized_counts <- "Output_files/normalized_counts.txt" #normalized counts
normalized_counts_log <- "Output_files/normalized_counts_log.txt"  #normalized counts log
normalized_quantile <- "Output_files/quantile_normalization.txt"
counts.plot = "~/luka_graduation/final_results/Output_files/plot_normalization.pdf"#normalization plot for first 50 genes

#Input plaque types / clinical info
plaque_types <- "~/luka_graduation/final_results/Input_data/Seurat_clusters.txt"
clinical_info_file <- "~/luka_graduation/final_results/Input_data/clinical_data_good_selection.txt"

#directory path where the input networks are (based on ensembl IDs) 
directory_path <- "~/luka_graduation/final_results/GRNs"
#directory_path_keydrivers <- "~/luka_graduation/final_results/Keydrivers"
...
question = "plaque only" #"plaque combined" "plaque only"  I used F if neither of them is used,meaning another feature of the clinical_info only
