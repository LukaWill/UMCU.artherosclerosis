...
directory_path_keydrivers <- "~/Graduation/Rstudio/Keydrivers"
...
module_score_file <- "module_score_networks_All_plaque.csv"
...
result_no_overlap <- "network_genes_no_overlap_percentage_All_plaque.txt"

#violin plot module score
violin_plot_module <- "~/Graduation/Rstudio/test/violin_plot_module_score_All_plaque.pdf"

#Connectivity

heatmap_cor = "~/Graduation/Rstudio/Test/all_correlation_ALL_plaque.pdf" #correlation heatmap for the total correlation of the network
dendogram_cluster_genes <- "cluster_genes_correlation_ALL_plaque.csv" #table of the dendogram clusters shown in the heatmap

directory <- "~/Graduation/Rstudio/Test/Networks" #directory to save the dendogram clusters separately

average_correlation_file <- "average_correlation_total_All_plaque.RData" #Rdata file that contains all average correlations
connectivity_plot <- "~/Graduation/Rstudio/Test/connectivity_grid_All_plaque.pdf" #connectivity plot that is based on the average correlation. 
